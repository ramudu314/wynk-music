...
const UpdatePassword = () => {
    ...
    const handleSubmit = (e) => {
        // Handle form submission or button click event
        e.preventDefault();
        ...
        <>
            <Box className="m-6 mb-3 min-[370px]:m-12 min-[370px]:mb-8 ">
                ...
                <Box>
                    ...
                    />
                    <Box
                        className={`text-[#f2a222] text-sm mt-1 ${isError.username === "" ? "hidden" : "block"
                            } `}
                    >
                        {isError.username}
                    </Box>
                ...
                <Box className="mt-4">
                    ...
                    />
                    <Box
                        className={`text-[#f2a222] text-sm mt-1 ${isError.email === "" ? "hidden" : "block"
                            } `}
                    >
                        {isError.email}
                    </Box>
                ...
                <Box>
                    ...
                    />
                    <Box
                        className={`text-[#f2a222] text-sm mt-1 ${isError.oldPassword === "" ? "hidden" : "block"
                            } `}
                    >
                        {isError.oldPassword}
                    </Box>
                ...
                <Box className="mt-4">
                    ...
                    />
                    <Box
                        className={`text-[#f2a222] text-sm mt-1 ${isError.newPassword === "" ? "hidden" : "block"
                            } `}
                    >
                        {isError.newPassword}
                    </Box>
                ...
                <Box className="mt-4 flex">
                    <button
                        type="submit"
                        className={`inline-flex w-28 justify-center py-2 px-4 text-sm leading-5 font-[500]text-white  border-[#ed1c24] border-[1px] rounded-full ${validateStates()
                                ? "bg-[#ed1c24]"
